...
class SequenceEditionSpaceState(Atom):
    ...
    #: If this.measurement has already been saved,  is it a template or not ?
...
class SequenceEditionSpace(Workspace):
    ...
    def start(self):
        ...
        """
        plugin = self.workbench.get_plugin(u'exopy.pulses')
        ...
        cmd = u'exopy.app.logging.add_handler'
    ...
    def stop(self):
        ...
        core = self.workbench.get_plugin(u'enaml.workbench.core')
        cmd = u'exopy.app.logging.remove_handler'
        core.invoke_command(cmd, {'id': LOG_ID}, self)

        self.workbench.unregister(u'exopy.pulses.workspace.menus')
...
#        prefs['item_id'] = 'exopy_pulses.RootSequence'
#        core = self.workbench.get_plugin('enaml.workbench.core')
#        cmd = 'exopy.pulses.build_sequence'
