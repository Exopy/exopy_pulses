# -*- coding: utf-8 -*-
#
# Ecpy_pulses documentation build configuration file, created by
...
project = u'Ecpy pulses'
copyright = u'2015-2016, Ecpy team'
...
latex_documents = [
  ('index', 'Ecpy_pulses.tex', u'Ecpy pulses Documentation',
   u'Ecpy team', 'manual'),
]
...
man_pages = [
    ('index', 'ecpy pulses', u'Ecpy pulses Documentation',
     [u'Ecpy team'], 1)
]
